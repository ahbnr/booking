...
@boundClass
export default class CreateBookingDialog extends React.Component<Properties, State> {
    ...
    onFirstNameChanged(changeEvent: ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) {
    ...
    onLastNameChanged(changeEvent: ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) {
        const value = changeEvent.target.value;
    ...
    async onSubmit() {
        await Client.createBooking(
            this.props.timeslot.id,
            {
                name: `${this.state.firstName} ${this.state.lastName}`
            }
        )

        this.props.changeInteractionState(new ViewingTimeslots(this.props.timeslot.weekday));
    }
